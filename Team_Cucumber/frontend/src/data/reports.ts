import type { ReportDataType, ReportFieldType } from "../types";

export const reportFieldList: ReportFieldType[] = [
  {
    text: "거래 금지 물품이에요.",
    path: "bans",
  },
...
export const banReports: ReportFieldType[] = [
...
export const inappropriateReports: ReportFieldType[] = [
...
export const fraudReports: ReportFieldType[] = [
  {
...
export const userReports: ReportFieldType[] = [
...
export const reports: ReportDataType = {
  landing: {
    title: "게시글을 신고하는 이유를 선택해주세요.",
...
export const reportAll: Record<string, ReportFieldType[]> = {
  landing: reportFieldList,
  bans: banReports,
  professional: [],
  inappropriates: inappropriateReports,
  proxy: [],
  frauds: fraudReports,
  users: userReports,
};
